...
public class DeleteIfContainsDosage extends AbstractDeleteIfContains
{
	...
	private static final String PREFIXED_UNIT = "(" + PREFIX + "?" + UNIT + "|(I?U))";
	...
	DeleteIfContainsDosage(final String... strings)
	{
		...
		if ((strings != null) && (strings.length > 0))
		{
			...
			matcher = prepareMatcher("%|" + day + "|(" + START + "(" + PREFIXED_UNIT + "|(i?u))" + END + ")");
		} else
			matcher = prepareMatcher("%|(" + START + "(" + PREFIXED_UNIT + "|(i?u))" + END + ")");
	}
