...
/**
 * delete terms, longer than 5 words and returns empty list. WARNING: This rule
 * will probably not lead to optimal results as shown in Hettne et al. Journal
 * of Biomedical Semantics 2010, 1:5.
 *
 * @author buechel
 *
 */
